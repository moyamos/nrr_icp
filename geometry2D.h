...
Pose compute_relative_pose(const std::vector<nrr_TrICP_Pack>& Pack, double eps);

Pose MbICP_compute_relative_pose(const std::vector<nrr_TrICP_Pack>& Pack, double eps);
